            ...
            for (int j=threadIdx.x+blockIdx.y*blockDim.x;j<n;j+=blockDim.x*gridDim.y){
                ...
                if (end_ka==batch){
                    for (int k=0;k<batch;k+=4){
                        {   
                            if(buf[k*3+0]==0&&buf[k&3+1]==0&&buf[k*3+2]==0){
                                if(k==0){
                                    best=999999;
                                    best_i=k+k2;
                                }
                        ...
                        {
                            if(!(buf[k*3+3]==0&&buf[k&3+4]==0&&buf[k*3+5]==0)){
                        ...
                        {
                            if(!(buf[k*3+6]==0&&buf[k&3+7]==0&&buf[k*3+8]==0)){
                        ...
                        {
                            if(!(buf[k*3+9]==0&&buf[k&3+10]==0&&buf[k*3+11]==0)){
