...
@ops.RegisterGradient('NnDistance_noZero')
...
if __name__=='__main__':
    ...
    with tf.Session('') as sess:
        xyz1=np.array([[[0,0,0], [0.1,0.1,0.1], [1,1,1],[2,2,2]]]).astype('float32')
        xyz2=np.array([[[0,0,0],[-1,-1,-1], [1,1,1],[2,2,2]]]).astype('float32')
        ...
        trainloss, b=sess.run([reta, retc])
        print(trainloss)
        print(b)
